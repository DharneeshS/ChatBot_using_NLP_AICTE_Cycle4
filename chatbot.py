...
file_path = os.path.abspath("C:/Users/DHARNEESH/OneDrive/Desktop/Implementation of ChatBot using NLP/Chatbot_using_NLP_AICTE_Cycle4-main/Chatbot_using_NLP_AICTE_Cycle4-main/intents.json")
